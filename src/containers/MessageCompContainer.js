...
import ComposeBox from '../components/MessageCompose';
import { thunkAddMessage } from '../actions/messages';

class MessageCompContainer extends Component {
  constructor(props) {
    super(props);
    this.state = { value: '' };
...
export default connect(mapStateToProps, mapDispatchToProps)(MessageCompContainer);